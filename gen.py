...
class Block(nn.Module):
    """
    This is the building block for the generator model, which can perform either downsampling or upsampling.

    Parameters:
    - in_channels (int): Number of input channels.
    - out_channels (int): Number of output channels.
    - down (bool): If True, performs downsampling. Otherwise, performs upsampling.
    - use_dropout (bool): If True, applies dropout.
    """
...
class Generator(nn.Module):
    """
    Generator model for DroGAN, capable of generating drought maps.

    Parameters:
    - in_channels (int): Number of input channels.
    - features (int): Base number of features to use within the network.
    """
    ...
    def __init__(self, in_channels=5, features=64):
        ...
        self.up3 = Block(features * 8 * 2, features * 8, down=False, act="relu")
...
def test():
    """Function to test the Generator model with a sample input"""
    ...
    with torch.no_grad():
        ...
        # Expected output shape: (1, 1, 512, 512)
